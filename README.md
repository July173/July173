...
- Perfil de usuario (cambio de foto y contraseña)
- Frontend web (React + TS)
- Backend (API REST)
- Aplicación móvil (.NET MAUI – solo visualización)

**Arquitectura:**
- Cliente – Servidor (SPA + API + Base de Datos)
- Frontend SPA con arquitectura **feature-based**
